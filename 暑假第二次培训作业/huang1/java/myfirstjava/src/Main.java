...
public class Main{
    public static void main(String[] args) {
        ...
        for(int i=4;i>0;i--){
            if(z==0){
                if(i==1){
                    System.out.println("√"+contentList[x-i]);

                }
                else System.out.println(contentList[x-i]);
            }
            else {
                if(5-i==z){
                    System.out.println("√"+contentList[x+3-i]);

                }
                else System.out.println(contentList[x+3-i]);
            }
        }
